...
void multiplica_matrizes(void)
{
   ...
   while(flag)
   {
      ler_matriz(&matriz_A);/*aloca memoria para a matriz e le valores para linha e coluna*/
      ler_matriz(&matriz_B);/*aloca memoria para a matriz e le valores para linha e coluna*/
