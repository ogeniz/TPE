...
void multiplica_matrizes(Matriz *, Matriz *, Matriz *);
...
int main(void)
{
   Matriz matriz_A,matriz_B,matriz_Mult;
   multiplica_matrizes(&matriz_A,&matriz_B,&matriz_Mult);
   ...
   libera_matriz(matriz_Mult.address,&(matriz_A.row));
   return 0;
}
/*multiplica duas matrizes e guarda o resultado em uma matriz resultante*/
void multiplica_matrizes(Matriz *matriz_A,Matriz *matriz_B,Matriz *matriz_Mult)
{
   ushort i,j,k;
   uchar flag = TRUE;
   while(flag)
